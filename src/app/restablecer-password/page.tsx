      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-4">
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Este enlace no es válido. Solicita un nuevo restablecimiento de contraseña.
            </CardDescription>
          </CardHeader>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-4">
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Tu contraseña se ha actualizado correctamente.</CardDescription>
          </CardHeader>
          <CardContent className="text-center">
