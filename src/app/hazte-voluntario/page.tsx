...
export default function HazteVoluntarioPage() {
  ...
  const PERIODOS = ['Semanal', 'Quincenal', 'Mensual', 'Puntual'];
  ...
  const validate = (): boolean => {
    ...
    if (!form.residencia.trim()) e.residencia = 'Requerido';
    if (!form.fecha_nacimiento) e.fecha_nacimiento = 'Requerido';
    if (!form.periodicidad) e.periodicidad = 'Selecciona una opción';
    setErrors(e);
      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-4">
        ...
        <Card className="w-full max-w-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Hemos recibido tu solicitud de voluntariado. Te notificaremos por email cuando sea revisada.
            </CardDescription>
          </CardHeader>
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 p-4 py-12">
      ...
      <Card className="w-full max-w-2xl">
        <CardHeader>
          <CardTitle>Hazte voluntario</CardTitle>
          <CardDescription>
            Rellena el formulario para unirte a nuestro equipo de voluntarios.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <Input name="residencia" value={form.residencia} onChange={handleChange} placeholder="Ciudad / Municipio" />
            ...
            <div>
              ...
              <Input name="horario_texto" value={form.horario_texto} onChange={handleChange} placeholder="Ej: Por las tardes después de las 16:00" />
            </div>

            <div>
              <Label className="mb-2 block">Áreas de interés</Label>
