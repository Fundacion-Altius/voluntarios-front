...
const TASK_STATUS_LABELS: Record<string, string> = {
  todo: 'Por hacer', in_progress: 'En progreso', review: 'Revisión', done: 'Completado',
};
        ...
        {isCoordinator && (
          <Dialog open={taskOpen} onOpenChange={setTaskOpen}>
            <DialogTrigger asChild>
              <Button size="sm"><Plus className="mr-1 size-4" /> Nueva tarea</Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
              ...
              <div className="space-y-4 pt-2">
                <div className="space-y-2">
                  <Label>Título</Label>
                  <Input value={newTaskTitle} onChange={(e) => setNewTaskTitle(e.target.value)} placeholder="Título de la tarea" />
                </div>
                <div className="space-y-2">
          ...
          return (
            <div key={col} className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                {colTasks.length === 0 && (
                  <p className="py-4 text-center text-xs text-muted-foreground">Sin tareas</p>
                )}
              </div>
            </div>
          );
