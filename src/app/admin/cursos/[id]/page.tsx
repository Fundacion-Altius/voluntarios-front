...
export default function EditarCursoPage() {
  ...
  const handleDeleteLesson = async () => {
    ...
    try {
      ...
      showSuccess('Lección eliminada correctamente');
      fetchCourse();
    } catch (err: any) {
      setError(err.message);
    }
              ...
              <Dialog open={moduleDialogOpen} onOpenChange={setModuleDialogOpen}>
                ...
                <DialogContent>
                  ...
                  <form onSubmit={handleAddModule} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="moduleOrder">Orden</Label>
                      <Input
                        id="moduleOrder"
                        type="number"
                    ...
                    <Button type="submit" className="w-full" disabled={moduleSubmitting}>
                      {moduleSubmitting ? 'Creando...' : 'Crear Módulo'}
                    </Button>
                  </form>
                </DialogContent>
              </Dialog>
            ...
            <CardContent>
              {course.modules && course.modules.length > 0 ? (
                            ...
                            >
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Se eliminará el módulo <strong>{deleteModuleTarget?.title}</strong> y todas sus lecciones.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                        ...
                                        >
                                          ...
                                          <AlertDialogContent>
                                            <AlertDialogHeader>
                                              ...
                                              <AlertDialogDescription>
                                                Se eliminará la lección <strong>{deleteLessonTarget?.lessonId}</strong>.
                                              </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
                                              <AlertDialogCancel>Cancelar</AlertDialogCancel>
                ...
                <p className="py-4 text-center text-muted-foreground">
                  No hay módulos todavía. Crea el primer módulo para comenzar.
                </p>
              )}
            </CardContent>
          </Card>
